...
public class DataPreProcessing {
    ...
    String repoName;
    String dbLocation;
    static DataPreProcessing config = null;
    int recordFrom;
    int recordTo;
    ...
    public static DataPreProcessing getConfig() {
        if(config==null){
    ...
    public static void setConfig(DataPreProcessing config) {
        DataPreProcessing.config = config;
    }
